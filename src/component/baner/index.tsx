...
import banner from "./backgroundBanner.jpg"
  ...
  <Document>
    <Page style={styles.page} size={{width: 960, height:1920}}  orientation="landscape">
      <View style={styles.view}>
        <Image style={styles.image}  src={banner}  />
        <Text style={{ fontSize: "101px",  left: '320px',top:"54px", ...styles.text }}>Gabriel Simon Gianotti</Text>
        <Text style={{  left: '330px',top:"170px", fontSize: "60px", width:'1144px', height:"auto", ...styles.text }}>Fez uma contribição para o repositorio swagger-js</Text>
      </View>
    </Page>
  </Document>
);
